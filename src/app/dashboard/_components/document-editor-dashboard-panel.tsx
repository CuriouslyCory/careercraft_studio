...
/**
 * Dashboard Document Editor Panel that handles editing documents based on URL parameters
 * Expected URL params: jobPostingId, documentType, jobTitle
 * Routes back to dashboard job postings instead of ai-chat
 */
export function DocumentEditorDashboardPanel() {
  ...
  return (
    <div className="h-[calc(100%-6rem)] flex-col space-y-4">
      {/* Header */}
